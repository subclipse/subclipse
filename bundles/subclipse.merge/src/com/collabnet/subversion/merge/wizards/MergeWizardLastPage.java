...
public class MergeWizardLastPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		SelectionListener conflictSelectionListener = new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				if (treeConflictPromptButton.getSelection()) settings.put(LAST_TREE_CONFLICT_CHOICE, SVNConflictResolver.PROMPT);
				else if (treeConflictResolveButton.getSelection()) settings.put(LAST_TREE_CONFLICT_CHOICE, ISVNConflictResolver.Choice.chooseMerged);
	...
	public void setVisible(boolean visible) {
		...
		if (visible) {
			IMergeInputProvider selectedMergeInputProvider = ((MergeWizard)getWizard()).getSelectedMergeInputProvider();
