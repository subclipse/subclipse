...
public class OverrideAndUpdateSynchronizeAction extends SynchronizeModelAction {
  ...
  public OverrideAndUpdateSynchronizeAction(
      String text, ISynchronizePageConfiguration configuration) {
  ...
  protected FastSyncInfoFilter getSyncInfoFilter() {
    return new FastSyncInfoFilter() {
      public boolean select(SyncInfo info) {
        SyncInfoDirectionFilter filter =
  ...
  protected SynchronizeModelOperation getSubscriberOperation(
    ...
    return new OverrideAndUpdateSynchronizeOperation(
        configuration, elements, resources, resources, changeSetSelected);
  }
}
