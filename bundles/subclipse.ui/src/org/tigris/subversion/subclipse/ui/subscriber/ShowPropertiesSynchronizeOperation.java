...
public class ShowPropertiesSynchronizeOperation extends SVNSynchronizeOperation {
  ...
  public ShowPropertiesSynchronizeOperation(
      ISynchronizePageConfiguration configuration, IDiffElement[] elements, IResource resource) {
            ...
            getShell()
                ...
                .syncExec(
                    new Runnable() {
                      public void run() {
                        try {
                          SvnPropertiesView view =
                              (SvnPropertiesView) showView(SvnPropertiesView.VIEW_ID);
                          if (view != null) {
