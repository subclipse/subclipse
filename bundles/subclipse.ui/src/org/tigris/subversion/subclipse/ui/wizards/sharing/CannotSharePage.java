...
public class CannotSharePage extends SVNWizardPage {
  ...
  public CannotSharePage(
      String pageName, String title, ImageDescriptor titleImage, IProject project) {
  ...
  public void createControl(Composite parent) {
    ...
    createWrappingLabel(
        composite,
        Messages.CannotSharePage_2 + project.getName() + Messages.CannotSharePage_0,
        0 /* indent */,
        1 /* columns */);
