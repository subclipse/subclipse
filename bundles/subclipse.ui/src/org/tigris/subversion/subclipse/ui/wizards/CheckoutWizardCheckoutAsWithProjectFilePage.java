...
public class CheckoutWizardCheckoutAsWithProjectFilePage extends WizardPage {
  ...
  public CheckoutWizardCheckoutAsWithProjectFilePage(
  ...
  public void createControl(Composite parent) {
    ...
    if (remoteFolders != null) {
      textLabel.setText(
          Policy.bind(
              "CheckoutWizardCheckoutAsPage.single", remoteFolders[0].getName())); // $NON-NLS-1$	
    }
    ...
    notAvailableLabel.setText(
        Policy.bind("CheckoutWizardCheckoutAsPage.notAvailable")); // $NON-NLS-1$
