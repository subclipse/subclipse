...
public class RemoteFolderElement extends SVNModelElement implements IDeferredWorkbenchAdapter {
  ...
  /**
   * Overridden to append the version name to remote folders which have version tags and are
   * top-level folders.
   */
  ...
  /**
   * @see
   *     org.tigris.subversion.subclipse.ui.model.SVNModelElement#internalGetChildren(java.lang.Object,
  ...
  public void fetchDeferredChildren(
      Object o, IElementCollector collector, IProgressMonitor monitor) {
    ...
    try {
      ...
      monitor.beginTask(
          Policy.bind("RemoteFolderElement_fetchingRemoteMembers.message", getLabel(o)),
          100); //$NON-NLS-1$
      FetchMembersOperation operation =
          new FetchMembersOperation(null, (ISVNRemoteFolder) o, collector);
