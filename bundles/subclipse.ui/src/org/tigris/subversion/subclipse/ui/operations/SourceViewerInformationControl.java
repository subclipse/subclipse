 ...
 *     org.eclipse.jface.text.source.projection.SourceViewerInformationControl Several changes are
 *     made in order to handle hover for CVS annotations
 */
class SourceViewerInformationControl
  ...
  public SourceViewerInformationControl(
      Shell parent, int shellStyle, int style, String symbolicFontName, String statusFieldText) {
    GridLayout layout;
    GridData gd;
    ...
    fViewer.configure(
        new TextSourceViewerConfiguration(EditorsUI.getPreferenceStore()) {
          protected Map getHyperlinkDetectorTargets(ISourceViewer sourceViewer) {
            ...
            //                // return Platform.getAdapterManager().getAdapter(CVSHistoryPage.this,
            // adapter);
            //                return null;
            //              }
            //            });
  ...
  public void setInput(Object input) {
    if (input instanceof String) setInformation((String) input);
    else setInformation(null);
  }
