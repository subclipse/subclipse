...
public class BuiltInConflictsCompareInput extends CompareEditorInput {
  ...
  public BuiltInConflictsCompareInput(
      CompareConfiguration configuration, SVNConflictDescriptor conflictDescriptor) {
    super(configuration);
    this.conflictDescriptor = conflictDescriptor;
  }

  public void setResources(
      File ancestor, File mine, File theirs, File destination, String fileName) {
  ...
  private String getCharSet() {
    ...
    int index =
        destFilePath.indexOf(
            File.separator
                + Policy.bind("BuiltInConflictsCompareInput.1")
    ...
    IFile destinationFile = (IFile) File2Resource.getResource(workspaceFile);
