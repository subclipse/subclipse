...
/**
 * Fetch the members of a remote folder in the background, passing incremental results through an
 * IElementCollector.
 */
public class FetchMembersOperation extends SVNOperation {
  ...
  public FetchMembersOperation(
      IWorkbenchPart part, ISVNRemoteFolder folder, IElementCollector collector) {
    super(part);
