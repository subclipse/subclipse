...
public interface ISVNUIConstants {
  ...
  public final String IMG_AFFECTED_PATHS_COMPRESSED_MODE =
      "elcl16/compressedLayout.gif"; //$NON-NLS-1$
  ...
  public final String IMG_FOLDERDELETE_PENDING =
      "pending16/folderdelete_pending.gif"; //$NON-NLS-1$
  public final String IMG_FILEMODIFIED_PENDING =
      "pending16/filemodified_pending.gif"; //$NON-NLS-1$
  public final String IMG_FOLDERMODIFIED_PENDING =
      "pending16/foldermodified_pending.gif"; //$NON-NLS-1$
  ...
  public final String PREF_FETCH_CHANGE_PATH_ON_DEMAND =
      "pref_fetch_change_path_on_Demand"; //$NON-NLS-1$
  ...
  public final String PREF_PROMPT_ON_SAVING_IN_SYNC =
      "pref_prompt_on_saving_in_sync"; //$NON-NLS-1$
  public final String PREF_SAVE_DIRTY_EDITORS = "pref_save_dirty_editors"; // $NON-NLS-1$
  public final String PREF_PROMPT_ON_CHANGE_GRANULARITY =
      "pref_prompt_on_change_granularity"; //$NON-NLS-1$
  public final String PREF_REPOSITORIES_ARE_BINARY = "pref_repositories_are_binary"; // $NON-NLS-1$
  public final String PREF_DETERMINE_SERVER_VERSION =
      "pref_determine_server_version"; //$NON-NLS-1$
  ...
  public final String PREF_SHOW_COMPARE_REVISION_IN_DIALOG =
      "pref_show_compare_revision_in_dialog"; //$NON-NLS-1$
  public final String PREF_SHOW_UNADDED_RESOURCES_ON_COMMIT =
      "pref_show_unadded_resources_on_commit"; //$NON-NLS-1$
  public final String PREF_SELECT_UNADDED_RESOURCES_ON_COMMIT =
      "pref_select_unadded_resources_on_commit"; //$NON-NLS-1$
  public final String PREF_REMOVE_UNADDED_RESOURCES_ON_REPLACE =
      "pref_remove_unadded_resources_on_replace";
  ...
  public final String PREF_MERGE_PROGRAM_PARAMETERS =
      "pref_merge_program_parameters"; //$NON-NLS-1$
  ...
  public final String PREF_GROUP_VERSIONS_BY_PROJECT =
      "pref_group_versions_by_project"; //$NON-NLS-1$
  ...
  public final String IMG_WIZBAN_RESOLVE_TREE_CONFLICT =
      "wizban/resolve_treeconflict_wizban.png"; //$NON-NLS-1$
  ...
  public final String PREF_ALLOW_EMPTY_COMMIT_COMMENTS =
      "pref_allow_empty_commit_comment"; //$NON-NLS-1$
  ...
  public final String PREF_UPDATE_TO_HEAD_ALLOW_UNVERSIONED_OBSTRUCTIONS =
      "pref_update_to_head_allow_unversioned_obstructions"; //$NON-NLS-1$
  public final String PREF_UPDATE_TO_HEAD_CONFLICT_HANDLING_TEXT_FILES =
      "pref_update_to_head_conflict_handling_text_files"; //$NON-NLS-1$
  public final String PREF_UPDATE_TO_HEAD_CONFLICT_HANDLING_BINARY_FILES =
      "pref_update_to_head_conflict_handling_binary_files"; //$NON-NLS-1$
  public final String PREF_UPDATE_TO_HEAD_CONFLICT_HANDLING_PROPERTIES =
      "pref_update_to_head_conflict_handling_properties"; //$NON-NLS-1$
  public final String PREF_UPDATE_TO_HEAD_CONFLICT_HANDLING_TREE_CONFLICTS =
      "pref_update_to_head_conflict_handling_tree_conflicts"; //$NON-NLS-1$
  ...
  public static final String HISTORY_VIEW_ID =
