...
public class EditConflictsSynchronizeOperation extends SVNSynchronizeOperation {
  ...
  public EditConflictsSynchronizeOperation(
              ...
              try {
                ...
                if (preferenceStore.getBoolean(ISVNUIConstants.PREF_MERGE_USE_EXTERNAL)) {
                  editConflictsExternal(
                      resource, conflictOldFile, conflictWorkingFile, conflictNewFile);
                } else {
  ...
  private void editConflictsExternal(
      final IFile resource, IFile conflictOldFile, IFile conflictWorkingFile, IFile conflictNewFile)
      throws CoreException, InvocationTargetException, InterruptedException {
