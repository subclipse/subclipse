...
public class StringMatcher {
  ...
  public StringMatcher.Position find(String text, int start, int end) {
    if (fPattern == null || text == null) throw new IllegalArgumentException();
  ...
  /**
   * This method parses the given pattern into segments separated by wildcard '*' characters. Since
