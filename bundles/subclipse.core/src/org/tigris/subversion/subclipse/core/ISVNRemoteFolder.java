...
/**
 * This interface represents a remote folder in a repository. It provides access to the members
 * (remote files and folders) of a remote folder
 *
...
public interface ISVNRemoteFolder extends ISVNRemoteResource, ISVNFolder {
   ...
   * @throws SVNException
   */
  void createRemoteFolder(String folderName, String message, IProgressMonitor monitor)
      throws SVNException;
