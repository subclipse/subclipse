		...
		public String getColumnText(Object element, int columnIndex) {
			...
			switch (columnIndex) {
				case COL_REVISION:
					...
					return revision;
				case COL_TAGS:
					return TagManager.getTagsAsString(entry.getAliases());
				case COL_DATE:
...
//		private VersionCollator versionCollator = new VersionCollator();
		...
		int compareColumnValue(int columnNumber, ILogEntry e1, ILogEntry e2) {
			switch (columnNumber) {
				...
				case COL_TAGS: /* tags */
					String tags1 = TagManager.getTagsAsString(e1.getAliases());
					String tags2 = TagManager.getTagsAsString(e2.getAliases());
