...
public class SvnWizardRevertPage extends SvnWizardDialogPage {
	...
	private void addResourcesArea(Composite composite) {
		resourceSelectionTree = new ResourceSelectionTree(composite, SWT.NONE, Policy.bind("GenerateSVNDiff.Changes"), resourcesToRevert, statusMap, null, false, null); //$NON-NLS-1$
