...
public class SvnWizardMarkResolvedPage extends SvnWizardDialogPage {
	...
	public void createControls(Composite parent) {
		...
		else if (lastChoice == ISVNConflictResolver.Choice.chooseMineFull) chooseUserVersionButton.setSelection(true);
		else if (lastChoice == ISVNConflictResolver.Choice.chooseTheirsFull) chooseIncomingVersionButton.setSelection(true);
		else if (lastChoice == ISVNConflictResolver.Choice.chooseBase) chooseBaseVersionButton.setSelection(true);		
